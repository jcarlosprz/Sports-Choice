...
public class Registrarse {
	...
	private void initialize() {
		...
		btnPregunta.setIcon(new ImageIcon(Registrarse.class.getResource("/images/pregunta-32x32.png")));
		...
		btnFlecha.setIcon(new ImageIcon(Registrarse.class.getResource("/images/back-arrow-icon-10.png")));
